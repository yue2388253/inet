  ...
  protected:
    ...
    virtual const char *getTags() const override {
        switch (activityLevel) {
            case ACTIVITY_LEVEL_SERVICE: return "physical layer service";
            case ACTIVITY_LEVEL_PEER: return "physical layer peer";
            case ACTIVITY_LEVEL_PROTOCOL: return "physical layer protocol";
